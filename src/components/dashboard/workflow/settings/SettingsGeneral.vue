<template>
  <div class="flex items-center">
    ...
    <ui-select :model-value="settings.onError" @change="updateSetting('onError', $event)">
  ...
  <div class="flex items-center pt-4">
    <div class="mr-4 flex-1">
      ...
      <p class="text-sm leading-tight text-gray-600 dark:text-gray-200">
        Workflow execution environment (Use "Popup" if workflow runs more than 5 minutes)
      </p>
    </div>
  ...
  <div v-for="item in settingItems" :key="item.id" class="flex items-center pt-4">
    <div class="mr-4 flex-1">
      <p>
        {{ item.name }}
      </p>
