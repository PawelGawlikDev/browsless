<template>
  <div class="events mt-4">
    <div class="flex items-center">
      ...
      <ui-button :disabled="!state.selectedBlock" variant="accent" @click="executeBlock">
        Execute
      </ui-button>
    </div>
    <component
...
import EditForms from '@/components/dashboard/workflow/edit/EditForms.vue';
import EditTriggerEvent from '@/components/dashboard/workflow/edit/EditTriggerEvent.vue';
import EditScrollElement from '@/components/dashboard/workflow/edit/EditScrollElement.vue';
