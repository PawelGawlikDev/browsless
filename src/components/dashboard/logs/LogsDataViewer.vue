...
<script setup>import { shallowReactive, computed, defineAsyncComponent, onMounted, } from 'vue';
...
const exportData = (type) => {
    dataExporter(logsData?.table || logsData, { name: state.fileName, type }, true);
};
onMounted(async () => {
