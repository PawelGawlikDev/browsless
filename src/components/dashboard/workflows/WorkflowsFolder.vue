  ...
  <div class="mt-6 border-t pt-4">
    <div class="flex items-center text-slate-600 dark:text-slate-300">
      ...
      <button
        ...
        @click="newFolder"
      >
        <v-remixicon size="20" name="riAddLine" class="inline-block align-sub" />
    ...
    <ui-list class="mt-2 space-y-1">
      <ui-list-item
        ...
        :active="modelValue === ''"
        color="bg-accent/15 text-slate-900 ring-1 ring-accent/25 dark:text-slate-100"
...
const exportFolderWorkflows = (folderId) => {
...
const onWorkflowsDrop = async ({ dataTransfer }, folderId) => {
