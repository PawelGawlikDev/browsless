  ...
  <div>
    ...
    >
      ...
      <ui-input
        ...
        @change="
          updateData({
            toNumber: +$event <= data.fromNumber ? data.fromNumber + 1 : +$event,
          })
        "
      />
    </div>
    ...
    <ui-modal v-model="state.showDataModal" title="Data" content-class="max-w-3xl">
