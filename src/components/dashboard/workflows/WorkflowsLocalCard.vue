      ...
      <div class="mb-4 flex items-center">
        ...
        <ui-popover class="ml-2 h-6">
          ...
          <ui-list class="space-y-1" style="min-width: 165px">
            <ui-list-item class="cursor-pointer" @click="$emit('toggleDisable')">
            ...
            <ui-list-item class="cursor-pointer" @click="$emit('togglePin')">
              ...
              <span>{{ t(`workflow.pinWorkflow.${isPinned ? 'unpin' : 'pin'}`) }}</span>
            </ui-list-item>
            <ui-list-item
              v-for="item in menu"
              :key="item.id"
...
import SharedCard from '@/components/dashboard/shared/SharedCard.vue';
