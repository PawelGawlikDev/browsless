...
import type { BrowserApiMapItem } from '@/types/runtime';
import { browser as Browser } from 'wxt/browser';

export const browserAPIMap: BrowserApiMapItem[] = [
  ...
  { api: () => extensionStorage.local.get, path: 'storage.local.get' },
  { api: () => extensionStorage.local.set, path: 'storage.local.set' },
  { api: () => extensionStorage.local.remove, path: 'storage.local.remove' },
