      ...
      >
        <template #item="{ element }">
          ...
          >
            ...
            >
              <template #prepend>
                <button class="absolute ml-2" @click="copySelector(name, value)">
...
const copySelector = (name, value) => {
  rootElement.shadowRoot.querySelector(`[data-testid="${name}"] input`)?.select();
