<template>
  <div class="max-w-2xl">
    ...
    <div class="mt-1 flex items-center space-x-4">
      <ui-input v-model.number="settings.minZoom" type="number" label="Min zoom" />
      <ui-input v-model.number="settings.maxZoom" type="number" label="Max zoom" />
    </div>
    <ui-list class="mt-8 space-y-2">
      ...
      <transition-expand>
        <div
          ...
          style="margin-top: 0"
        >
          <ui-input v-model.number="settings.snapGrid[0]" type="number" label="X Axis" />
          <ui-input v-model.number="settings.snapGrid[1]" type="number" label="Y Axis" />
        </div>
      </transition-expand>
      <ui-list-item small>
