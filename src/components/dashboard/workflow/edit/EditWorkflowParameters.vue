<template>
  ...
  >
    ...
    <section v-else class="w-full">
      ...
      <draggable v-model="state.parameters" tag="div" item-key="id" handle=".handle">
          ...
          <div class="mb-4">
            <div class="grid grid-cols-12 space-x-2">
              ...
              <div class="col-span-2">
                ...
                >
                  <option v-for="type in paramTypesArr" :key="type.id" :value="type.id">
                    {{ type.name }}
                  </option>
                </ui-select>
              </div>
              ...
              <div class="col-span-4 flex items-center">
                ...
                <ui-input
                  ...
                  placeholder="NULL"
                />
                <ui-button icon class="ml-2" @click="state.parameters.splice(index, 1)">
