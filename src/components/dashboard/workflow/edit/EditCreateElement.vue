<template>
  ...
  >
    ...
    <ui-button variant="accent" class="mt-4 w-full" @click="state.showModal = true">
    ...
    >
      ...
      >
        <ui-tab-panel value="html" class="h-full">
          <shared-codemirror v-model="blockData.html" lang="html" class="h-full" />
        </ui-tab-panel>
        <ui-tab-panel value="css" class="h-full">
          <shared-codemirror v-model="blockData.css" lang="css" class="h-full" />
        </ui-tab-panel>
        ...
        <ui-tab-panel value="preloadScript">
          ...
          <ui-button class="mt-4" @click="addPreloadScript"> Add script </ui-button>
        </ui-tab-panel>
      </ui-tab-panels>
    </ui-modal>
  </edit-interaction-base>
...
const availableFuncs = [
  { name: 'browslessRefData(keyword, path?)', id: 'browslessrefdata-keyword-path' },
  { name: 'browslessExecWorkflow(options)', id: 'browslessexecworkflow-options' },
];
const insertOptions = ['before', 'after', 'prev-sibling', 'next-sibling', 'replace'];
const tabs = [
  { id: 'html', name: 'HTML' },
  { id: 'css', name: 'CSS' },
...
const autocompleteList = [
  browslessFuncsSnippets.browslessExecWorkflow,
  browslessFuncsSnippets.browslessRefData,
];
