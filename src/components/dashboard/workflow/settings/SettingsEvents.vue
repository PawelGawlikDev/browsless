  ...
  <div>
    ...
    >
      ...
      <div class="mt-1 flex flex-wrap items-center space-x-2">
        ...
        <ui-popover v-if="WORKFLOW_EVENTS.length !== actionModal.data.events.length">
          <template #trigger>
            <ui-button class="!h-8 !px-3">
              <v-remixicon name="riAddLine" class="-ml-1 mr-2" height="20" width="20" />
...
const EVENT_ACTIONS = {
  ...
  'js-code': {
    code: "const workflow = browslessRefData('workflow');\nconsole.log(\n\tworkflow.status,\n\tworkflow.logs,\n\tworkflow.errorMessage\n)",
    type: 'js-code',
  },
};
