      ...
      <div class="condition-group relative flex">
        ...
        <div class="flex-1 space-y-2">
              ...
              <div class="condition-item">
                ...
                >
                  <template #header>
                    ...
                    />
                    <v-remixicon name="mdiDrag" class="handle ml-2 cursor-move" />
                  </template>
                  <div class="space-y-2 px-4 py-2">
                    <condition-builder-inputs
                      :autocomplete="autocomplete"
                      :data="inputs.items"
                      @update="conditions[index].conditions[inputsIndex].items = $event"
                    />
                  </div>
                </ui-expand>
              </div>
          ...
          <div class="condition-action mt-2 space-x-2 text-sm">
            ...
            <ui-button v-if="index === conditions.length - 1" @click="addOrCondition">
              <v-remixicon name="riAddLine" class="-ml-2 mr-1" size="20" />
...
const getDefaultValues = (items = ['value', 'compare', 'value']) => {
  const defaultValues = {
    value: {
      type: 'value',
      category: 'value',
...
const getConditionText = ({ category, type, data }) => {
  if (category === 'compare') {
...
const deleteCondition = (index, itemIndex) => {
